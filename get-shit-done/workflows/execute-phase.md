...
Parse JSON for: `executor_model`, `verifier_model`, `spec_reviewer_model`, `code_reviewer_model`, `commit_docs`, `parallelization`, `branching_strategy`, `branch_name`, `phase_found`, `phase_dir`, `phase_number`, `phase_name`, `phase_slug`, `plans`, `incomplete_plans`, `plan_count`, `incomplete_count`, `state_exists`, `roadmap_exists`, `quality_tdd_mode`, `quality_specs`, `quality_two_stage_review`, `quality_feedback`, `quality_checkpoints`, `quality_coverage_threshold`.
